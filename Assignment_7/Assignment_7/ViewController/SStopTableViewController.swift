...
class SStopTableViewController: UITableViewController, UISearchResultsUpdating {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if(isFiltering()){
            ...
            object = schedule!.stops[indexPath.row].name
        }
    ...
    func filterContentForSearchText(_ searchText: String){
        ...
        filtedObjs = schedule!.stops.filter({ (stop:Stop) -> Bool in
    ...
    */
    ...
    override func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCell.EditingStyle, forRowAt indexPath: IndexPath) {
        if editingStyle == .delete {
            ...
            schedule!.stops.remove(at: indexPath.row)
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        //            let indexPath = tableView.indexPathForSelectedRow
            ...
            if isFiltering() {
                ...
                vc.stop = schedule!.stops[indexPath!.row]
            }
        }
    }
}
