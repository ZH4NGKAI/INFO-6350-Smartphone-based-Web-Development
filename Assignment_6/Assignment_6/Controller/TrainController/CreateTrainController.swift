...
class CreateTrainController: UIViewController {
    ...
    @IBAction func createTrainBtn(_ sender: CustomButton) {
        ...
        let train = AppDelegate.trains.addTrain(line: name)
